...
Kapitel~\ref{chap:einleitung} umreißt Motivation, Zielsetzung, Forschungsfragen und
Methodik. Kapitel~\ref{chap:grundlagen} erarbeitet die fachlichen Grundlagen zu Cyber Ranges,
Cyber-Resilienz und Schwachstellen-Scannern. Kapitel~\ref{chap:stand-der-technik} ordnet den
Stand der Technik ein und betrachtet bestehende Cyber-Range-Plattformen sowie verwandte
Arbeiten. In Kapitel~\ref{chap:auswahl} werden ein Kriterienkatalog entwickelt, die
betrachteten Plattformen verglichen und die Auswahl begründet. Kapitel~\ref{chap:konzeption}
beschreibt die Konzeption der Use Cases und die Evaluationsmethodik, bevor
Kapitel~\ref{chap:implementierung} deren technische Umsetzung in der gewählten Cyber Range
darlegt. Kapitel~\ref{chap:evaluation} präsentiert und diskutiert die Evaluationsergebnisse.
Kapitel~\ref{chap:fazit} fasst die Arbeit zusammen, beantwortet die Forschungsfragen und gibt
einen Ausblick.
