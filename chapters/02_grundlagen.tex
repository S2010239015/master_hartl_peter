...
Die Laufzeitumgebung stützt sich dabei auf unterschiedliche Werkzeugklassen: Virtualisierungsswerkzeuge (z.\,B.\ VMware, VirtualBox, KVM oder QEMU sowie Cloud-Frameworks wie
...
wie Firewalls, Server und Router werden als echte Hardware dupliziert. Das wirk extrem Real, ist jedoch mit erheblichen Nachteilen verbunden -- hohe Anschaffungs- und
...
dxv\subsection{Einsatzzwecke: Testing, Training und Forschung}
...
sondern verallgemeinert werden können \cite[76--78]{IntroductionCyberRanges2022}\cite{Chouliaras2021}\cite{Yamin2020CyberRanges}.
